    ...
    <>
      <div className="min-h-screen bg-background">
        ...
        <div className="relative bg-secondary text-secondary-foreground">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3DfA%3D&auto=format&fit=crop&w=2070&q=80')] bg-cover bg-center opacity-20" />
            ...
            <div className="text-center">
              ...
              <div className="mt-8">
                <button
                  ...
                  className="flex items-center gap-2 bg-purple-600 text-white px-6 py-3 rounded-md hover:bg-purple-700 mx-auto"
                >
